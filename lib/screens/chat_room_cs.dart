...
class ChatRoomCS extends StatefulWidget {
  const ChatRoomCS({super.key});

  @override
  State<ChatRoomCS> createState() => _ChatRoomCSState();
}

class _ChatRoomCSState extends State<ChatRoomCS> {
  @override
  ...
  Future<void> storeMessage(MessageModel message) async {
    final docUser = FirebaseFirestore.instance.collection('chat_room_cs').doc();
